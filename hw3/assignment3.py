...
def InitGL(Width, Height):  # We call this right after our OpenGL window is created.
    ...
    object.vertices, object.faces = ObjParser.parse()
...
def DrawGLScene():
    ...
    text = "Subdivision Level : " + str(object.subdivision_level)
    for ch in text:
...
def keyPressed(*args):
    ...
    if key == chr(27):
        ...
        object.add_subdivision()
    elif key == '-':
        object.remove_subdivision()
    elif key == 'f':
...
print("Hit ESC key to quit.\n" +
      ...
      "left/right arrow key -> rotation around vertical axis\n" +
      "f -> reset view")
main()
